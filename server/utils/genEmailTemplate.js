...
const genAccessEmailTemplate = (id, email, firstName, lastName) => {
  const accessEmail = {
    body: {
      ...
      intro: [`${firstName} ${lastName} (${email}) is requesting access to the For Animals database website.`, `If you recongnize ${firstName}, please click the GREEN button below to grant access. If you do not recognize him/her, please click the grey button!`],
      action: [
        {
          ...
          button: {
            color: '#485148',
            text: 'Click to not grant access',
